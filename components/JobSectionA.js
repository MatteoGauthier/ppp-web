    ...
    <div className="flex flex-col sm:flex-row card bg-deep-black">
      ...
      <div className="flex flex-col justify-center w-full px-4 py-6 space-y-2 sm:w-7/12 sm:p-0 sm:pl-8">
        ...
        <p className="lg:text-lg text-gray-clay">
          Le product design est omniprésent dans votre quotidien, dans votre placard,
          dans votre cuisine. Il donne vie à vos objets de tous les jours.
          Découvrez le métier de product designer à travers une description de son parcours et de ses 
          réalisations. Nous avons interviewé Aymeric Delpeuch, lui-même Product Designer, pour vous 
          permettre de mieux comprendre et d'avoir une approche réaliste du métier.
        </p>
