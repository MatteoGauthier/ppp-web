  ...
  return (
    <div className="flex card bg-deep-black">
      <div className="flex flex-row w-5/12 h-auto overflow-visible bg-transparent image-section">
        <img className="z-20 object-cover w-4/12 sliced-image" src="/images/kelly-sikkema-v9FQR4tbIq8-unsplash (1).jpg" alt="" />
        <img className="z-10 object-cover w-5/12 sliced-image" src="/images/brad-neathery-mGH253KbfaY-unsplash (1).jpg" alt="" />
        <img className="object-cover w-1/2 sliced-image" src="/images/mia-baker-klRB1BB9pV8-unsplash (2).jpg" alt="" />
      </div>
      <div className="flex flex-col justify-center w-7/12 pl-8 space-y-2">
        <h2 className="text-6xl leading-tight text-white font-radio-grotesk font-bold">Product Designer</h2>
